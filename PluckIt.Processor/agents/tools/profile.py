...
async def get_user_profile(config: RunnableConfig) -> str:
    ...
    return json.dumps({
        ...
        "wishlist_style_keywords": profile.get("wishlistStyleKeywords") or [],
        "wishlist_preferred_colours": profile.get("wishlistPreferredColours") or [],
        "wishlist_favorite_brands": profile.get("wishlistFavoriteBrands") or [],
        "wishlist_garment_interests": profile.get("wishlistGarmentInterests") or [],
        "wishlist_profile_updated_at": profile.get("wishlistProfileUpdatedAt"),
