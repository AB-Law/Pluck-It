  ...
  template: `
    ...
    >
      ...
      <div class="flex flex-1 min-h-0 overflow-hidden">
        ...
        <aside
          class="w-80 flex-shrink-0 border-r border-border-chrome overflow-y-auto p-4 space-y-2 hidden md:block"
        >
          @if (loading()) {
        ...
        @if (showCollectionsList()) {
          ...
          >
            ...
            @if (loading()) {
              ...
              <div class="flex flex-col items-center justify-center py-12 text-slate-600 text-sm">
                <span class="material-symbols-outlined mb-3" style="font-size:40px"
                  >folder_off</span
                >
                <p>No collections yet.</p>
                <button
        ...
        >
          @if (activeCollection(); as col) {
            ...
            @if (col.memberUserIds.length > 0) {
              <div class="mb-6">
                <h5 class="mb-3 text-xs font-bold uppercase tracking-widest text-slate-500">
                  Members
                </h5>
            ...
            @if (collectionItems().length === 0) {
              <div class="flex flex-col items-center justify-center py-16 text-slate-600">
                ...
                <a routerLink="/vault" class="mt-3 text-primary text-xs underline"
                  >Go to vault to add items</a
                >
              </div>
            } @else {
      ...
      .pipe(
        ...
        switchMap(() => {
          ...
          return this.collectionService
            .join(joinId)
            .pipe(switchMap(() => this.collectionService.loadAll().pipe(map(() => joinId))));
        }),
        tap((joinId) => {
