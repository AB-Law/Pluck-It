  ...
  template: `
    ...
    >
      ...
      >
        ...
        @if (draft) {
          <div
            class="flex items-center justify-between px-4 py-4 md:px-6 md:py-6 border-b border-[#1F1F1F] shrink-0"
          >
            <div class="flex items-center gap-4">
              <!-- Thumbnail -->
              <div
                class="w-12 h-12 bg-[#0d0d0d] border border-[#1F1F1F] flex items-center justify-center overflow-hidden shrink-0"
              >
                <img
                  [src]="draft.imageUrl"
                  alt="Item preview"
          ...
          <div class="flex-1 overflow-y-auto modal-scroll px-4 py-4 md:px-8 md:py-7">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
              ...
              <div class="space-y-7">
                ...
                <div>
                  <label
                    class="block text-xs font-semibold text-slate-400 uppercase tracking-widest mb-3"
                  >
                    Brand
                  </label>
                  <div class="relative">
                    <span
                      class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-slate-500 pointer-events-none"
                ...
                <div>
                  ...
                  <div class="flex">
                    <div
                      class="bg-[#1F1F1F] text-slate-300 font-mono h-12 px-4 flex items-center border border-[#1F1F1F] text-sm shrink-0 select-none"
                    >
                      {{ currency }}
                    </div>
                    <input
                ...
                <div>
                  ...
                  >
                    Tags
                    <span
                      class="ml-2 bg-primary/20 text-primary text-[10px] font-mono px-1.5 py-0.5 tracking-wider"
                    >
                      AI SUGGESTED
                    </span>
                  </label>
                  ...
                  <div class="flex flex-wrap gap-2 mb-2">
                    @for (tag of draft.tags; track tag) {
                      <span
                        class="inline-flex items-center gap-1 px-2 py-1 bg-[#1a1a1a] border border-[#333] text-slate-300 text-[11px] font-mono uppercase tracking-wide"
                      >
                        {{ tag }}
                        <button
                          type="button"
                          class="touch-target text-slate-500 hover:text-red-400 transition-colors ml-1 p-0.5"
                          (click)="removeTag(tag)"
                ...
                <div>
                  ...
                  >
                    <span class="inline-flex items-center gap-2">
                      ...
                      @if (!isEditMode) {
                        <span
                          class="bg-primary/20 text-primary text-[10px] font-mono px-1.5 py-0.5 tracking-wider"
                        >
                          AI SUGGESTED
                        </span>
                      }
                  ...
                  <div class="relative">
                    ...
                    >
                      @if (draft.category && !categories.includes(draft.category)) {
                        <option [value]="draft.category" class="bg-black">
                          {{ draft.category }}
                        </option>
                      }
                ...
                @if (currentSizeType !== 'none') {
                  <div>
                    ...
                    >
                      Size
                      @if (sizeSystem) {
                        <span class="ml-2 text-[10px] font-mono text-slate-500"
                          >({{ sizeSystem }})</span
                        >
                      }
                    </label>
                    ...
                    @if (currentSizeType === 'bottoms') {
                      <div class="flex gap-3">
                        <div class="flex-1">
                          <label class="block text-[10px] text-slate-500 font-mono mb-1.5"
                            >WAIST (in)</label
                          >
                          <div class="relative">
                            <select
                            ...
                            <span
                              class="material-symbols-outlined absolute right-2 top-1/2 -translate-y-1/2 text-slate-500 pointer-events-none"
